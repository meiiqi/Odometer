...
public class Lab2 {
	...
	public static void main(String[] args) {
		...
		EV3ColorSensor csSensor = new EV3ColorSensor(colorPort);		// usSensor is the instance
		SampleProvider csColor = csSensor.getColorIDMode();	// usDistance provides samples from this instance
		...
		OdometryCorrection odometryCorrection = new OdometryCorrection(odometer, csColor, csData);
